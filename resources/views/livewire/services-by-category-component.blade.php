                            ...
                            @if ($scategory->services->count() > 0)
                                @foreach($scategory->services as $service)
                                    <div class="col-xs-6 col-sm-4 col-md-3 nature hsgrids"
                                        ...
                                        <a class="g-list" href="{{route('home.service_details',['service_slug'=>$service_slug])}}">
                                            <div class="img-hover">
                                            ...
                                            <div class="info-gallery">
                                                ...
                                                <hr class="separator">
                                                <p>{{$service->tagline}}</p>
                                                <div class="content-btn"><a href="{{route('home.service_details',['service_slug'=>$service_slug])}}"
                                ...
                                @endforeach
                            @else
                                <div class="col-md-12"><p class="text-center">There is any service</p></div>
                            @endif
                        </div>
                    </div>
                </div>
